  ...
  return (
    <>
      ...
      >
        <div
          className={
            "bg-white w-full p-6 md:p-12 mx-auto mt-16 vertical-spacing"
          }
        >
          ...
          <form onSubmit={(e) => e.preventDefault()} className={"border"}>
            <div className={"grid sm:grid-cols-2"}>
              <div
                ...
                className={`${
                  activeTab === "shipping"
                    ? "border-t-green-5"
                    : "border-t-transparent bg-gray-100"
                } border-t-[3px] w-full p-4`}
              >
            ...
            <div
              className={`${
                activeTab === "shipping" ? "mt-4" : "hidden"
              } vertical-spacing gap-6 p-4 lg:px-24 w-full`}
            >
              <h3
                className={
                  "py-4 border-b md:w-fit text-lg md:text-2xl font-extrabold"
                }
              >
              ...
              <div className={"vertical-spacing gap-6"}>
                <h3
                  className={"py-4 border-b text-lg md:text-2xl font-extrabold"}
                >
                  Billing Details
                </h3>
                <div className={"grid gap-4 md:grid-cols-2"}>
                  <input
                    ...
                    className={
                      "border px-5 py-2 outline-none active:ring-0 w-full"
                    }
                  />
                  <input
                    type={"text"}
                ...
                <label className={"vertical-spacing gap-2"}>
                  {/*Country/Region*/}
                  <select className={"px-5 py-2 bg-white border"}>
              ...
              <div>
                <Table className={"border rounded-lg"}>
                  ...
                  <TableBody>
                          ...
                          <TableCell className="font-medium">
                            <div className={"flex items-center gap-4"}>
                              ...
                              >
                                <div
                                  className={
                                    "min-h-16 min-w-16 h-16 w-16 rounded-lg center-items p-4"
                                  }
                                  style={gradientBackground}
                                >
                                  <img src={images[0].url} alt={name} />
                                </div>
                                <h2 className={"text-blue-5 font-light"}>
                                  {name}
                                </h2>
                              </Link>
                            </div>
                    ...
                    <TableRow>
                      <TableCell className={"p-4 text-lg font-bold"}>
                        Total
                      </TableCell>
                      <TableCell className={"p-4 text-lg font-bold text-right"}>
                        92,000ugx
                      </TableCell>
                    </TableRow>
                  </TableBody>
